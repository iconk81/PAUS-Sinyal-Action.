...
def highlight_style(row):
    ...
    if target_col:
        ...
        # Update: OPEN sekarang dapet warna hijau ENTRY
        ...
        with placeholder.container():
            if target_col:
                ...
                if time_col:
                    ...
                    # Update: Hitung OPEN sebagai ENTRY di Summary
                ...
                if current_total_rows > st.session_state.last_row_count:
                    ...
                    for _, row in new_added_rows.iterrows():
                        ...
                        # Update: Tambahkan OPEN ke filter Telegram
                        if status_aksi in ['ENTRY', 'EXIT', 'OPEN']:
                            ...
                            # Logika pesan: OPEN dianggap ENTRY
